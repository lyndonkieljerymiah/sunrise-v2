...
class ContractRegisterForm extends FormRequest
{
    ...
    public function messages()
    {
        ...
        return [
            ...
            'register_tenant.email_address.email'       => 'Email must be valid',
    ...
    public function getValidatorInstance() {
        ...
        $validator->after(function() use ($validator){
            ...
            if (Carbon::now()->lt($periodStart)) {
                $validator->errors()->add('start', 'Start must be current of future date');
            }
            if (Carbon::now()->lt($periodStart)) {
                $validator->errors()->add('start', 'Start must be current of future date');
            }
    ...
    public function filterInput() {
        ...
        if(isset($result['villa_list']))
            unset($result['villa_list']);
